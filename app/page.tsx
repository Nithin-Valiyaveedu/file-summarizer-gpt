          ...
          <div className="text-white bg-login-gradient 850px:w-[50%] 2xl:w-[70%] 850px:rounded-l-[21px] p-10 h-[100%]">
            <Carousel
              ...
              renderIndicator={(onClickHandler, isSelected, index, label) => {
                return (
                  <span
                    className={`cursor-pointer mr-4 px-2.5 py-1.5 text-sm rounded-full ${
                      isSelected
              ...
              <div className="text-left h-[85vh]">
                <div className="bg-youtubCard w-full xl:w-[75%] p-2 rounded-lg mt-8 h-1/2">
                  <iframe
                    height="100%"
                    width="100%"
              ...
              <div className="text-left h-[85vh] ">
                <div className="bg-youtubCard xl:w-[75%] p-2 rounded-lg mt-8 h-1/2">
                  <iframe
                    height="100%"
                    width="100%"
                    src="https://www.youtube.com/embed/QH2-TGUlwu4?fs=0&color=white&controls=0&disablekb=1"
